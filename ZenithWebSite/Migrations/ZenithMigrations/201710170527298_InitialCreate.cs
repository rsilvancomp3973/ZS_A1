namespace ZenithWebSite.Migrations.ZenithMigrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ActivityDescription = c.String(nullable: false, maxLength: 40),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Events", "EnteredBy_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Events", "ActivityTypeId", "dbo.ActivityTypes");
            ...
            DropIndex("dbo.Events", new[] { "EnteredBy_Id" });
            DropIndex("dbo.Events", new[] { "ActivityTypeId" });
